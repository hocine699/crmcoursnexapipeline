<?php
    ...
    $allSettings = \App\Models\Utility::settings();
    $logo = \App\Models\Utility::get_file('uploads/landing_page_image');
    $sup_logo = \App\Models\Utility::get_file('uploads/logo');
...
<head>
    ...
    <link rel="stylesheet" href=" <?php echo e(asset('assets/landing-page/custom.css')); ?>" />
                    ...
                    <div class="container-offset">
                        <div class="row gy-3 g-0 align-items-center">
                            ...
                            <div class="col-xxl-8 col-md-6">
                                <div class="<?php echo e(isset($settings['home_banner']) ? 'dash-preview' : ''); ?>">
                                ...
                                <?php if($key % 2 == 0): ?>
                                    <div class="row align-items-center justify-content-center mb-4">
                                        ...
                                        <div class="col-lg-7 col-md-6 res-img">
                                            <div
                                                class="<?php echo e(!empty($value['other_features_image']) ? 'img-wrapper' : ''); ?>">
                                ...
                                <?php $__currentLoopData = json_decode($settings['screenshots'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-md-4 col-sm-6">
                                        <div class="screenshot-card">
                                            <div class="<?php echo e(!empty($value['screenshots']) ? 'img-wrapper' : ''); ?>">
                    ...
                    <div class="container">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <?php
                                ...
                                $collection = \App\Models\Plan::where('status', true)->orderBy('price', 'ASC')->get();
                            ?>
...
<?php /**PATH /var/www/html/Modules/LandingPage/Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>