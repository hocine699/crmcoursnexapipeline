                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" data-toggle="switchbutton" data-onstyle="primary" class="" name="discover_status" id="discover_status" {{ $settings['discover_status'] == 'on' ? 'checked="checked"' : '' }}>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                <a data-size="lg" data-url="{{ route('discover_create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" data-title="{{__('Create Discover')}}" class="btn btn-sm btn-primary">
