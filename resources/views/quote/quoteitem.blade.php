{{ Form::open(['route' => ['quote.storeitem', $quote->id], 'class' => 'needs-validation', 'novalidate']) }}
<div class="row">
    ...
    <div class="form-group col-md-6">
        ...
        {{ Form::text('quantity', null, ['class' => 'form-control quantity', 'required' => 'required', 'placeholder' => __('Enter Quantity')]) }}
    </div>
    <div class="form-group col-md-6">
