            ...
            <table>
                <tbody>
                    <tr>
                        <td>
                            <h3
                                style="text-transform: uppercase; font-size: 40px; font-weight: bold; color: {{ $color }}; margin-bottom: 10px;">
                                QUOTE</h3>
                            <table class="no-space" style="width: 70%;">
                                <tbody>
                                    <tr>
                                        <td>Number: </td>
                                        <td class="text-right">
                                            {{ \App\Models\Utility::invoiceNumberFormat($settings, $quote->invoice) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Issue Date:</td>
