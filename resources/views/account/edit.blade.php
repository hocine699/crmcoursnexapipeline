...
@section('action-btn')
    <div class="btn-group" role="group">
        @if (!empty($previous))
            <div class="action-btn  ms-2" style="margin-right :4px;">
            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                    <div id="useradd-1" class="card">
                        ...
                        {{ Form::model($account, ['route' => ['account.update', $account->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="action-btn bg-primary me-2 float-end">
                                                <a class="mx-3 btn btn-sm  align-items-center text-white"
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            {{ Form::label('billing_country', __('Postal Code'), ['class' => 'form-label']) }}<x-required></x-required>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            {{ Form::label('shipping_postalcode', __('Postal Code'), ['class' => 'form-label']) }}<x-required></x-required>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            {{ Form::label('document_id', __('Document'), ['class' => 'form-label']) }}<x-required></x-required>
                                            {!! Form::select('document_id', $document_id, null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Select Document')]) !!}
                                            @error('industry')
                                                <span class="invalid-industry" role="alert">
                                                    <strong class="text-danger">{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('user', $user, $account->user_id, ['class' => 'form-control ', 'required' => 'required', 'placeholder' => __('Select User')]) !!}
                                            @error('user')
                    ...
                    <div id="useradd-2" class="card">
                        {{ Form::open(['route' => ['streamstore', ['account', $account->name, $account->id]], 'method' => 'post', 'enctype' => 'multipart/form-data','class' => 'needs-validation', 'novalidate']) }}
                        <div class="card-header">
                            <h5>{{ __('Stream') }}</h5>
                                                    ...
                                                    <li class="list-group-item border-0 d-flex align-items-start mb-2">
                                                        <div class="avatar me-3">
                                                            ...
                                                            <a href="{{ !empty($stream->file_upload) ? $profile . $stream->file_upload : $profile . 'avatar.png' }}"
                                                                target="_blank">
                                                                <img alt="" class="rounded border-2 border border-primary"
                                    ...
                                    <tbody>
                                        @foreach ($opportunitiess as $opportunities)
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge status_badge bg-success p-2 px-3">{{ !empty($opportunities->stages) ? $opportunities->stages->name : '-' }}</span>
                                                </td>
                                                        ...
                                                        @can('Show Opportunities')
                                                            <div class="action-btn  me-2">
                                                                <a href="#" data-size="md"
                                                                    ...
                                                                    title="{{ __(' Details') }}"class="mx-3 btn btn-sm  bg-warning align-items-center text-white">
                                                                    <i class="ti ti-eye"></i>
                                                                </a>
                                                            </div>
                                                        @endcan
                                        ...
                                        @foreach ($cases as $case)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($case->status == 0)
                                                        <span
                                                            class="badge status_badge bg-primary p-2 px-3 ">{{ __(\App\Models\CommonCase::$status[$case->status]) }}</span>
                                                    @elseif($case->status == 1)
                                                        <span
                                                            class="badge status_badge bg-info p-2 px-3 ">{{ __(\App\Models\CommonCase::$status[$case->status]) }}</span>
                                                    @elseif($case->status == 2)
                                                        <span
                                                            class="badge status_badge bg-warning p-2 px-3 ">{{ __(\App\Models\CommonCase::$status[$case->status]) }}</span>
                                                    @elseif($case->status == 3)
                                                        <span
                                                            class="badge status_badge bg-danger p-2 px-3 ">{{ __(\App\Models\CommonCase::$status[$case->status]) }}</span>
                                                ...
                                                <td>
                                                    @if ($case->priority == 0)
                                                        <span
                                                            class="badge status_badge bg-primary p-2 px-3 ">{{ __(\App\Models\CommonCase::$priority[$case->priority]) }}</span>
                                                    @elseif($case->priority == 1)
                                                        <span
                                                            class="badge status_badge bg-info p-2 px-3 ">{{ __(\App\Models\CommonCase::$priority[$case->priority]) }}</span>
                                                    @elseif($case->priority == 2)
                                                        <span
                                                            class="badge status_badge bg-warning p-2 px-3 ">{{ __(\App\Models\CommonCase::$priority[$case->priority]) }}</span>
                                                    @elseif($case->priority == 3)
                                                        <span
                                                            class="badge status_badge bg-danger p-2 px-3 ">{{ __(\App\Models\CommonCase::$priority[$case->priority]) }}</span>
                                                    @endif
                                                </td>
                                                <td>
                                                    <span
                                                        ...
                                                        @can('Show CommonCase')
                                                            <div class="action-btn  me-2">
                                                                <a href="#" data-size="md"
                                                                    ...
                                                                    title="{{ __('Details') }}"
                                                                    data-title="{{ __('Cases Details') }}"
                                                                    class="mx-3 bg-warning btn btn-sm  align-items-center text-white">
                                                                    <i class="ti ti-eye"></i>
                                                                </a>
                                                            </div>
                                                        @endcan
                                                        @can('Edit CommonCase')
                                                            <div class="action-btn  me-2">
                                                                <a href="{{ route('commoncases.edit', $case->id) }}"
                                                                    class="mx-3 bg-info btn btn-sm  align-items-center text-white"
                                                                    data-bs-toggle="tooltip" title="{{ __('Edit') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($document->status == 0)
                                                        <span
                                                            class="badge status_badge bg-success p-2 px-3">{{ __(\App\Models\Document::$status[$document->status]) }}</span>
                                                    @elseif($document->status == 1)
                                                        <span
                                                            class="badge status_badge bg-warning p-2 px-3">{{ __(\App\Models\Document::$status[$document->status]) }}</span>
                                                    @elseif($document->status == 2)
                                                        <span
                                                            class="badge status_badge bg-danger p-2 px-3">{{ __(\App\Models\Document::$status[$document->status]) }}</span>
                                    ...
                                    <tbody>
                                        @foreach ($tasks as $task)
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge status_badge bg-success p-2 px-3 ">{{ !empty($task->stages) ? $task->stages->name : '' }}</span>
                                                </td>
                                                <td>
                                                    <span
                                                        class="badge status_badge bg-success p-2 px-3 ">{{ \Auth::user()->dateFormat($task->start_date) }}</span>
                                                </td>
                                                <td>
                                                    <span
                                    ...
                                    <tbody>
                                        @foreach ($quotes as $quote)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($quote->status == 0)
                                                        <span class="badge status_badge bg-secondary p-2 px-3"
                                                            style="width: 79px;">{{ __(\App\Models\Quote::$status[$quote->status]) }}</span>
                                                    @elseif($quote->status == 1)
                                                        <span class="badge status_badge bg-info p-2 px-3"
                                                            style="width: 79px;">{{ __(\App\Models\Quote::$status[$quote->status]) }}</span>
                                                    @endif
                                                </td>
                                                <td>
                                                        ...
                                                        @can('Show Quote')
                                                            <div class="action-btn  me-2">
                                                                <a href="{{ route('quote.show', $quote->id) }}"
                                                                    data-size="md"class="mx-3 bg-warning btn btn-sm align-items-center text-white "
                                                                    data-bs-toggle="tooltip" title="{{ __('Details') }}"
                                                                    data-title="{{ __('Quote Details') }}">
                                                                    <i class="ti ti-eye"></i>
                                                                </a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($salesinvoice->status == 1)
                                                        <span class="badge status_badge bg-danger p-2 px-3"
                                                            style="width: 91px;">{{ __(\App\Models\Invoice::$status[$salesinvoice->status]) }}</span>
                                                    @elseif($salesinvoice->status == 2)
                                                        <span class="badge status_badge bg-warning p-2 px-3"
                                                            style="width: 91px;">{{ __(\App\Models\Invoice::$status[$salesinvoice->status]) }}</span>
                                                    @elseif($salesinvoice->status == 3)
                                                        <span class="badge status_badge bg-success p-2 px-3"
                                                            style="width: 91px;">{{ __(\App\Models\Invoice::$status[$salesinvoice->status]) }}</span>
                                                        ...
                                                        @can('Show Meeting')
                                                            <div class="action-btn  me-2">
                                                                <a href="#" data-size="md"
                                                                    ...
                                                                    data-ajax-popup="true" data-bs-toggle="tooltip"
                                                                    data-title="{{ __('Details') }}"title="{{ __('Details') }}"
                                                                    class="mx-3 btn btn-sm bg-warning align-items-center text-white ">
                                                                    <i class="ti ti-eye"></i>
                                                                </a>
                                                            </div>
