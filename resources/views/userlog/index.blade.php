            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12 col-12" style="margin-right: 12px">
                            {{ Form::select('user', $usersList, isset($_GET['users']) ? $_GET['users'] : '', ['class' => 'form-control select ', 'id' => 'id']) }}
                        </div>
                        <div class="action-btn me-2 col-auto float-end">
                            <button type="submit" class="m-1 bg-primary btn btn-sm align-items-center text-white"
                        ...
                        <div class="action-btn  col-auto float-end" style="margin-left:5px" >
                            <a href="{{ url('userlog') }}" data-bs-toggle="tooltip"
                                title="{{ __('Reset') }}"data-title="{{ __('Reset') }}"
                                class="mx-3 btn bg-danger btn-sm align-items-center text-white"><i class="ti ti-refresh"></i></a>
                        </div>
                    </div>
                    {{ Form::close() }}
                </div>
                        ...
                        <table id="datatable" class="table align-items-center datatable">
                            ...
                            @foreach ($users as $user)
                                ...
                                <tr>
                                    ...
                                    <td> <span class="me-5 badge p-2 px-3 status_badge bg-success">{{ $userType->type}}</span></td>
                                    <td>{{ $user->ip }}</td>
                                    <td>{{ $user->date }}</td>
                                    <td>{{ $json->country }}</td>
                                    ...
                                    <td>
                                        ...
                                        <div class="action-btn">
                                            ...
                                            <a href="#!" class="mx-3 bg-danger btn btn-sm align-items-center show_confirm ">
