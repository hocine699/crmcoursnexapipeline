...
@endphp
{{ Form::open(['url' => 'plan', 'enctype' => 'multipart/form-data','class' => 'needs-validation', 'novalidate']) }}
<div class="row">
    ...
    <div class="col-6">
        <div class="form-group ">
            ...
            {{ Form::number('max_user', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter Maximum User')]) }}
            <span class="small"><b>{{ __('Note: "-1" for Unlimited') }}</b></span>
        </div>
    </div>
    <div class="col-6">
        <div class="form-group ">
    ...
    <div class="col-12">
        <div class="form-group">
            ...
            <div class="input-group">
                <input for="storage_limit" name="storage_limit" type="text" class="form-control" value="" placeholder="Enter Storage Limit"
                    required>
    ...
    <div class="col-12">
        <div class="form-group">
            {{ Form::label('description', __('Description')) }}<x-required></x-required>
