...
@endphp
{{ Form::open(['url' => 'coupon', 'method' => 'post','class' => 'needs-validation', 'novalidate']) }}
<div class="row">
    ...
    <div class="form-group col-md-12">
        ...
        {{ Form::text('name', null, ['class' => 'form-control font-style', 'placeholder' => __('Coupon Name'), 'required' => 'required']) }}
    </div>
