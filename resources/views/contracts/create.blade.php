    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="form-group">
                {{ Form::label('name', __('Contract Name'),['class'=>'form-label']) }}<x-required></x-required>
                {{ Form::text('name', '', array('class' => 'form-control','required'=>'required','placeholder'=>__('Enter Name'))) }}
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
                {{ Form::label('client_name', __('User Name'),['class'=>'form-label']) }}<x-required></x-required>
                {{ Form::select('client_name', $client,null, array('class' => 'form-control select2','required'=>'required','placeholder'=>__('Select Name'))) }}
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                {{ Form::number('value', '', array('class' => 'form-control','required'=>'required','min' => '1','placeholder'=>__('Enter Value'))) }}
            </div>
        </div>
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                {{ Form::select('type', $contractType,null, array('class' => 'form-control select2','required'=>'required','placeholder'=>__('Select Type'))) }}
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::textarea('notes', '', array('class' => 'form-control','placeholder'=>__('Enter Descripton'))) }}
            </div>
        </div>
