            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('account', $account, null, ['class' => 'form-control','placeholder'=>__('Select Account')]) !!}
                                        </div>
                                        @error('account')
                                    ...
                                    <x-mobile divClass="col-6" name="phone" label="{{ __('Phone') }}"
                                       placeholder="{{ __('Enter Phone') }}" required="required"></x-mobile>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('user', $user, $contact->user_id, ['class' => 'form-control ','placeholder'=>__('Select User')]) !!}
                                        </div>
                                        @error('user')
                    ...
                    <div id="useradd-2" class="card">
                        {{ Form::open(['route' => ['streamstore', ['contact', $contact->name, $contact->id]], 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate']) }}
                        <div class="card-header">
                            <h5>{{ __('Stream') }}</h5>
                                                        ...
                                                        @can('Show Call')
                                                            <div class="action-btn  me-2">
                                                                <a href="#" data-size="md"
                                                                    ...
                                                                    title="{{ __('Details') }}"class="mx-3 bg-warning btn btn-sm align-items-center text-white  ">
                                                                    <i class="ti ti-eye"></i>
                                                                </a>
                                                            </div>
                                                        @endcan
                                                        ...
                                                        @can('Show Meeting')
                                                            <div class="action-btn  me-2">
                                                                <a href="#" data-size="md"
                                                                    ...
                                                                    data-ajax-popup="true" data-bs-toggle="tooltip"
                                                                    data-title="{{ __('Meeting Details') }}"title="{{ __('Details') }}"
