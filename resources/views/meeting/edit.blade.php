...
@section('action-btn')
    <div class="btn-group" role="group">
        ...
        @if (!empty($next))
            <div class="action-btn  ms-2" style="margin-right :4px;">
                <a href="{{ route('meeting.edit', $next) }}" class="btn btn-sm btn-primary btn-icon m-1"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::date('start_date', $start_date, ['class' => 'form-control datepicker', 'required' => 'required']) !!}
                                            @error('start_date')
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            {!! Form::date('end_date', $end_date, ['class' => 'form-control datepicker', 'required' => 'required']) !!}
                                            @error('end_date')
